	...
	_, err := client.Jobs.New(context.TODO(), chunkify.JobNewParams{
		Format: chunkify.JobNewParamsFormat{
			...
			HlsH264: chunkify.HlsH264Param{
				...
				HlsEncKey:      chunkify.String("0123456789abcdef"),
				HlsEncKeyURL:   chunkify.String("https://example.com/key"),
				HlsSegmentType: chunkify.HlsH264HlsSegmentTypeMpegts,
				HlsTime:        chunkify.Int(6),
				Level:          41,
				Maxrate:        chunkify.Int(100000),
				Minrate:        chunkify.Int(100000),
				Movflags:       chunkify.String("movflags"),
				Pixfmt:         chunkify.HlsH264PixfmtYuv410p,
				Preset:         chunkify.HlsH264PresetMedium,
				Profilev:       chunkify.HlsH264ProfilevHigh,
				Seek:           chunkify.Int(1),
				VideoBitrate:   chunkify.Int(100000),
				Width:          chunkify.Int(-2),
				X264Keyint:     chunkify.Int(60),
			},
			HlsH265: chunkify.HlsH265Param{
				AudioBitrate:   chunkify.Int(32000),
				Bufsize:        chunkify.Int(100000),
				Channels:       1,
				Crf:            chunkify.Int(23),
				...
				HlsEncKey:      chunkify.String("0123456789abcdef"),
				HlsEncKeyURL:   chunkify.String("https://example.com/key"),
				HlsSegmentType: chunkify.HlsH265HlsSegmentTypeMpegts,
				HlsTime:        chunkify.Int(6),
				Level:          41,
				Maxrate:        chunkify.Int(100000),
				Minrate:        chunkify.Int(100000),
				Movflags:       chunkify.String("movflags"),
				Pixfmt:         chunkify.HlsH265PixfmtYuv410p,
				Preset:         chunkify.HlsH265PresetMedium,
				Profilev:       chunkify.HlsH265ProfilevMain10,
				Seek:           chunkify.Int(1),
				VideoBitrate:   chunkify.Int(100000),
				Width:          chunkify.Int(-2),
				X265Keyint:     chunkify.Int(60),
			},
			Jpg: chunkify.JpgParam{
				Interval:      1,
			...
			MP4H265: chunkify.MP4H265Param{
				...
				Minrate:      chunkify.Int(100000),
				Movflags:     chunkify.String("movflags"),
				Pixfmt:       chunkify.MP4H265PixfmtYuv410p,
				Preset:       chunkify.MP4H265PresetMedium,
				Profilev:     chunkify.MP4H265ProfilevMain10,
				Seek:         chunkify.Int(1),
				VideoBitrate: chunkify.Int(100000),
				Width:        chunkify.Int(-2),
				X265Keyint:   chunkify.Int(60),
			},
			WebmVp9: chunkify.WebmVp9Param{
				AudioBitrate: chunkify.Int(32000),
				Bufsize:      chunkify.Int(100000),
				Channels:     1,
				...
				Maxrate:      chunkify.Int(100000),
				Minrate:      chunkify.Int(100000),
				Pixfmt:       chunkify.WebmVp9PixfmtYuv410p,
				Quality:      chunkify.WebmVp9QualityGood,
				Seek:         chunkify.Int(1),
				VideoBitrate: chunkify.Int(100000),
				Width:        chunkify.Int(-2),
			},
