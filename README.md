...
<a href="https://pkg.go.dev/github.com/stainless-sdks/chunkify-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/chunkify-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/chunkify-go" // imported as chunkify
)
```
...
```sh
go get -u 'github.com/stainless-sdks/chunkify-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/chunkify-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/chunkify-go/issues) with questions, bugs, or suggestions.
