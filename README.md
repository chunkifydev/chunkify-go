...
<a href="https://pkg.go.dev/github.com/chunkifydev/chunkify-go"><img src="https://pkg.go.dev/badge/github.com/chunkifydev/chunkify-go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/chunkifydev/chunkify-go@v0.12.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/chunkifydev/chunkify-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/chunkifydev/chunkify-go/issues) with questions, bugs, or suggestions.
