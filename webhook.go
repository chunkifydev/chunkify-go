...
type NewEventWebhookEvent struct {
	...
	Data NewEventWebhookEventDataUnion `json:"data"`
	...
	Event NewEventWebhookEventEvent `json:"event"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		ID          respjson.Field
		Data        respjson.Field
...
type UnwrapWebhookEvent struct {
	...
	ID string `json:"id"`
	// Event-specific payload data
	Data UnwrapWebhookEventDataUnion `json:"data"`
	// Timestamp when the notification was sent
	Date time.Time `json:"date" format:"date-time"`
	// Type of event that triggered the notification. Here are the possible events:
	//
	...
	// Any of "job.completed", "job.failed", "job.cancelled", "upload.completed",
	// "upload.failed", "upload.expired".
	Event UnwrapWebhookEventEvent `json:"event"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		ID          respjson.Field
		Data        respjson.Field
